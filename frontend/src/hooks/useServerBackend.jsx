...
function useServerBackend(backend_url, sid) {
  ...
  const queryNodes = useCallback(
    (boundsForQueries, setResult, setTriggerRefresh, config, treeposition) => {

      let url = backend_url + "/nodes/?type=leaves&sid="+sid +"&start_pos="+treeposition[0]+"&end_pos="+treeposition[1];

      console.log("useServerBackend", url)
