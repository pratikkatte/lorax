  ...
  const toRGB_uncached = useCallback(
    (string) => {
      if (typeof string == "number" || !isNaN(string)) {
        ...
        const scalingFactor = 1; // Adjust this factor to change distinctiveness
        const normalizedLog10 = Math.max(0, Math.min(1, log10 / scalingFactor));
        const color = scale.plasma(normalizedLog10);
