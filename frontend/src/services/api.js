...
export const fetchUCGBConfig = async (API_BASE, chrom, start, end) => {
  const response = await axios.get(`${API_BASE}/ucgb?chrom=${chrom}&genomiccoordstart=${start}&genomiccoordend=${end}`);
